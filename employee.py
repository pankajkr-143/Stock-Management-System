...
class employeeClass:
    def __init__(self,root):
        ...
        #title
        title=Label(self.root,text="Employee Details",font=("times new roman",15,"bold"),bg="#ff0000",fg="white").place(x=50,y=100,width=1000)
        ...
        lbl_contact=Label(self.root,text="Contact:",font=("times new roman",15,"bold"),bg="white").place(x=750,y=150)
        
        txt_empid=Entry(self.root,textvariable=self.var_emp_id,font=("times new roman",15,"bold"),bg="white").place(x=150,y=150,width=180)
        #txt_gender=Entry(self.root,textvariable=self.var_gender,font=("times new roman",15,"bold"),bg="white").place(x=500,y=150,width=180)
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Transgender","Other"),state="readonly",justify=CENTER,font=("goudy old style",15))
        cmb_gender.place(x=500,y=150,width=180)
        cmb_gender.current(0)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("times new roman",15,"bold"),bg="white").place(x=850,y=150,width=180)
        
        
        lbl_name=Label(self.root,text="Name:",font=("times new roman",15,"bold"),bg="white").place(x=50,y=190)
        lbl_dob=Label(self.root,text="DOB:",font=("times new roman",15,"bold"),bg="white").place(x=350,y=190)
        lbl_doj=Label(self.root,text="DOJ:",font=("times new roman",15,"bold"),bg="white").place(x=750,y=190)
        
        txt_name=Entry(self.root,textvariable=self.var_name,font=("times new roman",15,"bold"),bg="white").place(x=150,y=190,width=180)
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("times new roman",15,"bold"),bg="white").place(x=500,y=190,width=180)
        txt_doj=Entry(self.root,textvariable=self.var_doj,font=("times new roman",15,"bold"),bg="white").place(x=850,y=190,width=180)
        ...
        lbl_utype=Label(self.root,text="User Type:",font=("times new roman",15,"bold"),bg="white").place(x=750,y=230)
        
        txt_email=Entry(self.root,textvariable=self.var_email,font=("times new roman",15,"bold"),bg="white").place(x=150,y=230,width=180)
        txt_pass=Entry(self.root,textvariable=self.var_pass,font=("times new roman",15,"bold"),bg="white").place(x=500,y=230,width=180)
        #txt_utype=Entry(self.root,textvariable=self.var_utype,font=("times new roman",15,"bold"),bg="white").place(x=850,y=230,width=180)
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Select","Admin","Employee","Other"),state="readonly",justify=CENTER,font=("goudy old style",15))
        cmb_utype.place(x=850,y=230,width=180)
        cmb_utype.current(0)
        
        lbl_address=Label(self.root,text="Address:",font=("times new roman",15,"bold"),bg="white").place(x=50,y=270)
        lbl_salary=Label(self.root,text="Salary:",font=("times new roman",15,"bold"),bg="white").place(x=500,y=270)
        
        self.txt_address=Text(self.root,font=("times new roman",15,"bold"),bg="white")
        self.txt_address.place(x=150,y=270,width=300,height=60)
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("times new roman",15,"bold"),bg="white").place(x=600,y=270,width=180)
